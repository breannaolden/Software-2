...
A GUI-based scheduling desktop application which takes time zone of the user and the business into account. Created using Java, FXML, and SQL. Assigned project for course called Software II.
